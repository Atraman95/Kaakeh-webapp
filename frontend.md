...
### Typography
Choose fonts that are beautiful, unique, and interesting. Avoid generic fonts like Arial and Inter. Opt for distinctive, characterful choices that elevate the UI. Pair a distinctive display font with a refined body font.
...
- Every design looking the same — vary themes, fonts, and aesthetics across generations
